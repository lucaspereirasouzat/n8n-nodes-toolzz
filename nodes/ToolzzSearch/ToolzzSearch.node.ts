	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				type: 'string' as NodePropertyTypes,
				default: '',
				description: 'Digite os IDs grupos separados por virgula',
			},
			{
				...
				type: 'string' as NodePropertyTypes,
				default: '',
				description: 'Digite os IDs sub grupos separados por virgula',
			},
			{
				...
				type: 'string' as NodePropertyTypes,
				default: '',
				description: 'Digite os IDs especialidades separados por virgula',
			},
			{
				...
				type: 'string' as NodePropertyTypes,
				default: '',
				description: 'Digite os IDs tipos de conteudos separados por virgula',
			},
			{
				displayName: 'Tags',
				name: 'tags',
				type: 'string' as NodePropertyTypes,
				default: '',
				description: 'Digite as tags separados por virgula',
			},
		],
	};
