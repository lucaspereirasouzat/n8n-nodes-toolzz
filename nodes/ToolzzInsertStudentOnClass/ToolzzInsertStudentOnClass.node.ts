...
export class ToolzzInsertStudentOnClass implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Toolzz Insert Student On Class',
		name: 'toolzzInsertStudentOnClass',
		icon: 'file:toolzzInsertStudentOnClass.svg',
		group: ['transform'],
		version: 1,
