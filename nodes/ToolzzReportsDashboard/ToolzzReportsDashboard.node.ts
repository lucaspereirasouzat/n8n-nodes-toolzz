...
export class ToolzzReportsDashboard implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Toolzz Show Reports DashBoard',
		name: 'ToolzzReportsDashboard',
		icon: 'file:toolzzShowCourse.svg',
		group: ['transform'],
		version: 1,
		description: 'Buscar Curso com Suntoken',
		defaults: {
			name: 'ToolzzReportsDashboard',
		},
		inputs: ['main'],
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const options: OptionsWithUri = {
			...
			uri: `${uri}/api/reports/institution/dashboard`,
			json: true,
		};
